...
---
*Обзор без изменений кода — файлы проекта не модифицированы. HTML-версия с диаграммами и цветовой разметкой опубликована как Artifact.*
